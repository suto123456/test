...
//引数が一つだと()を外せる
const updateItem = id => {
    Inertia.put(route("items.update", { item: props.item.id }), form)
}
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="radio" id="status" name="status" v-model="form.is_selling" value="1">
                                        <label class="ml-2 mr-2">販売中</label>
                                        <input type="radio" id="status" name="status" v-model="form.is_selling" value="0">
