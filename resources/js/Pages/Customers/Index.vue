...
import Pagination from "@/Components/Paginatino.vue";
import { ref } from "vue";
import { Inertia } from '@inertiajs/inertia';


//v-model="search"からリアクティブな値を取得
const search = ref("")

//searchを引数にインデックスルートに飛ぶ
const searchCustomers = () =>{
    //refで変数を定義した場合には.valueで値を取り出す
                               ...
                               <FlashMessage />
                                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                                    <div>
                                        ...
                                        <button class="bg-blue-300 text-white py-2 px-2 ml-2"
