...
//郵便番号から住所を特定するライブラリ
//npm i yubinbango-core2 --forceでインストール
                        ...
                        <div class="container px-5 pt-8 mx-auto">
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            <!--ラベルのforとinputのidを紐づけて、ラベルを押した際にも入力モードになる-->
                                    ...
                                    <div class="p-2 w-full">
                                    <div class="relative">
                                        <label for="memo" class="leading-7 text-sm text-gray-600"></label>
